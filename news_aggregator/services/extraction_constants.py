...
BROWSER_TIMEOUT_FIRST_MS = 25_000
BROWSER_TIMEOUT_RETRY_MS = 35_000
BROWSER_TOTAL_BUDGET_MS = 90_000

# Heuristic quality thresholds
MIN_QUALITY_SCORE = 25  # Increased for production: filters out low-quality content
